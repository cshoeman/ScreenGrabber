...
#Region "Hotkey registration, unregistration and handling"
    ...
    End Sub
    Public Shared Sub registerHotkeyNoAscii(ByRef sourceForm As Form, ByVal triggerNum As Integer, ByVal modifier As KeyModifier)
        RegisterHotKey(sourceForm.Handle, 1, modifier, triggerNum)
    End Sub
